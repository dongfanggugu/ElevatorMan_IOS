...
int		t2u_add_port_ex(const char* uuid,const char* remote_ip,unsigned short remote_port,unsigned short local_port);
...
返回值:
		...
		-1:	端口不存在
*/
int		t2u_get_rate(unsigned short port,PT2uNetRate pRate);

int		t2u_add_udp_port(const char* uuid,unsigned short remote_port,unsigned short local_port);
int		t2u_add_udp_port_ex(const char* uuid,const char* remote_ip,unsigned short remote_port,unsigned short local_port);
...
int		t2u_get_udp_rate(unsigned short port,PT2uNetRate pRate);
...
返回值:
		...
		-1:	查询失败
*/
int		t2u_query_ex(const char * uuid,char* buff,int buffsize,char* ipaddr,int ipsize);
...
返回值 :  
		...
		-1		失败
*/
int		t2u_search(char* buff,int buffsize);
...
返回值:
		...
		-3:		查询超时，对方无响应
*/
int		t2u_search_dvr(const char* uuid,char* outbuff,int buffsize);
