...
#import "WRepairHistoryController.h"
#import "HttpClient.h"
#import "WRepairCell.h"
#import "WRepairDetailController.h"

@interface WRepairHistoryController()<UITableViewDelegate, UITableViewDataSource>
...
@implementation WRepairHistoryController
...
- (void)getHistoryList
{
    ...
    [[HttpClient sharedClient] view:self.view post:@"getRepairByWorkerComplete" parameter:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
