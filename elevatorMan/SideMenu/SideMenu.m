...
//#define SideMenuMinimumRelativePanDistanceToOpen 0.33

// constants
#define JDSideMenuMinimumRelativePanDistanceToOpen  0.33
#define JDSideMenuDefaultMenuWidth  260
#define JDSideMenuDefaultDamping  0.5

// animation times
#define JDSideMenuDefaultOpenAnimationTime  1
#define JDSideMenuDefaultCloseAnimationTime  0.3
...
- (void)awakeFromNib
{
    _contentController = [self.storyboard instantiateViewControllerWithIdentifier:@"PropertyManager"];
    _menuController = [self.storyboard instantiateViewControllerWithIdentifier:@"menuViewController"];
                 ...
                 menuController:(UIViewController*)menuController;
{
    ...
    if (self)
    {
        ...
        //_contentController = [self.storyboard instantiateViewControllerWithIdentifier:@"navVC"];
        //_menuController = [self.storyboard instantiateViewControllerWithIdentifier:@"menuVC"];
...
- (void)viewDidLoad;
{
    ...
    //[self setBackgroundImage:[UIImage imageNamed:@"menuwallpaper"]];
}
                    ...
                    animated:(BOOL)animated;
{
    ...
    [UIView animateWithDuration:(JDSideMenuDefaultCloseAnimationTime/2) animations:^{
         ...
         initialVelocity:(CGFloat)velocity;
{
    ...
    [UIView animateWithDuration:animated ? duration : 0.0 delay:0
         ...
         } completion:^(BOOL finished)
     {
        ...
        blockSelf.containerView.userInteractionEnabled = NO;
...
- (void)hideMenuAnimated:(BOOL)animated;
{
                     ...
                     completion:^(BOOL finished)
    {
        ...
        blockSelf.containerView.userInteractionEnabled = YES;
    }];
}
