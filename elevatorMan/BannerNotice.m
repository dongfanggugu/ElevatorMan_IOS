...
//  Copyright © 2015年 Hiway. All rights reserved.
//
...
+(id)bannerWith:(UIImage *)bannerImage bannerName:(NSString *)bannerName bannerContent:(NSString *)bannerContent
{
    ...
    viewHidden = [[UIView alloc] initWithFrame:CGRectMake(20, 0, SCREEN_WIDTH - 40, 70)];
    viewHidden.backgroundColor = [Utils getColorByRGB:@"#007ec5"];
    viewHidden.alpha = 0.85;
    
    viewHidden.layer.masksToBounds = YES;
    viewHidden.layer.cornerRadius = 8;
