...
@implementation RepairAnnotationView
...
- (void)showInfoView
{
    ...
    NSString *type = _info[@"type"];


    NSDictionary *data = _info[@"data"];

    if ([type isEqualToString:@"order"])
    {
        NSString *category = _info[@"category"];

        NSString *house = nil;
        NSString *worker = nil;

        if ([category isEqualToString:@"maint"])
        {
            house = data[@"villaInfo"][@"cellName"];
            worker = data[@"maintUserInfo"][@"name"];
        }
        else if ([category isEqualToString:@"repair"])
        {
            house = data[@"villaInfo"][@"cellName"];
            worker = data[@"workerInfo"][@"name"];
        }
    ...
    else if ([type isEqualToString:@"task"])
    {
        ...
        if ([category isEqualToString:@"maint"])
        {
            house = data[@"maintOrderInfo"][@"villaInfo"][@"cellName"];
            worker = data[@"maintOrderInfo"][@"maintUserInfo"][@"name"];
        }
        else if ([category isEqualToString:@"repair"])
        {
            house = data[@"repairOrderInfo"][@"villaInfo"][@"cellName"];

            worker = data[@"repairOrderInfo"][@"maintUserInfo"][@"name"];
        }
...
- (void)setOnClickDetail:(void (^)())onClickDetail
{
